...
interface SolutionHowWeSolvedProps {
  howWeSolved: NonNullable<SolutionContent["howWeSolved"]>;
}

export default function SolutionHowWeSolved({
  howWeSolved,
}: SolutionHowWeSolvedProps) {
  return (
